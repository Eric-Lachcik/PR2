...
/**
 * Clase principal de la aplicación que muestra una interfaz gráfica para
...
public class App {
    ...
    public static void Top10() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(frame, "Error al acceder a la base de datos: " + ex.getMessage(), "Error",
        ...
        sortButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(frame, "Error al acceder a la base de datos: " + ex.getMessage(),
    ...
    public static void Equipos() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(frame, "Error al acceder a la base de datos: " + e.getMessage(), "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(addFrame,
                                    "Error al acceder a la base de datos: " + ex.getMessage(), "Error",
                                    JOptionPane.ERROR_MESSAGE);
                        }
